"""Experiment 03 trainer — Weight Tying Ablation.

Research Question: Can weight tying improve parameter efficiency and reduce BPB without changing model capacity?

CHANGE LOG (relative to starter/train.py):
  - Line 54: cfg.tie_weights = True
...
def main():
    ...
    # Experiment 03 change: Enable weight tying
