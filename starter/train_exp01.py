"""Experiment 01 trainer — Optimizer Ablation: Adam -> AdamW.

Research Question: Does AdamW improve BPB compared to the baseline Adam optimizer?

CHANGE LOG (relative to starter/train.py):
  - Line 60: torch.optim.Adam  ->  torch.optim.AdamW
  - Line 60: added weight_decay=0.1
...
def main():
    ...
    # Experiment 01 change: AdamW with weight_decay=0.1 (lr unchanged at 3e-4)
