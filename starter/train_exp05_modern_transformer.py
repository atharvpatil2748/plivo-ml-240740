"""Experiment 05 trainer — Modern Transformer Architecture (RMSNorm, RoPE, SwiGLU, Weight Tying, BPE Tokenizer).

Research Question: Can a modern transformer architecture combined with byte-level BPE significantly outperform the baseline?

Result: YES (Dev BPB dropped from 2.3718 -> 2.0074).
"""
import argparse
import time
import torch
